# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-07-24 07:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('languages', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default='{}', max_length=200), size=None)),
                ('databases', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default='{}', max_length=200), size=None)),
                ('BackEnds', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default='{}', max_length=200), size=None)),
                ('FrontEnds', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default='{}', max_length=200), size=None)),
                ('Devtools', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default='{}', max_length=200), size=None)),
                ('otherLibraries', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default='{}', max_length=200), size=None)),
                ('Webservices', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default='{}', max_length=200), size=None)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hello.Person')),
            ],
        ),
        migrations.CreateModel(
            name='CompanyProject',
            fields=[
                ('personalproject_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='hello.PersonalProject')),
            ],
            bases=('hello.personalproject',),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='company',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='hello.Company'),
        ),
    ]
